...
function validateBusinessEmail(email) {
	// const nonBusinessEmails = ["gmail", "yahoo", "hotmail", "outlook", "aol", "rediffmail"];
	// let getDomain = email.split("@")[1].split(".")[0];
	// console.log(getDomain);
	// if (nonBusinessEmails.includes(getDomain)) {
	// 	return false;
	// }
	...
	// let getDomain = email.split("@")[1].split(".")[0];
	// console.log(getDomain);
	// if (getDomain === "gmail" || getDomain === "yahoo" || getDomain === "hotmail" || getDomain === "outlook" || getDomain === "aol" || getDomain === "rediffmail") {
	// 	return false;
	// }
	// else if( getDomain.length <= 1) return false
	// else return true;
...
const verifyPhoneNumber = (phoneNumber) => {
	console.log(phoneNumber?.toString().length, "-",phoneNumber, "phoneNumber");
...
module.exports = { verifyValidEmail, checkValidPhoneNumber, formatName, validateBusinessEmail, isAuthenticatedUser, verifyPhoneNumber };
